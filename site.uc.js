...
/*
	...
	Use 'site.uc.js/site.min.js' to add site wide specific code for availability
	to all your pages and apps. Also, add small jQuery plugin's here,
	(ie - jQuery FitText below).
...
msos.console.info('msos/site -> start.');
...
msos.console.info('msos/site -> done!');
